...
    const [editedCommentContent, setEditedCommentContent] = useState('');
    ...
    // FIX 1: Ensure these are always arrays to prevent TypeError: Cannot read properties of undefined (reading 'filter')
...
    );
    ...
    // FIX 2: Centralize the check for post.id before proceeding with the reaction
